    ...
    <GridWrapper >
      <Container style={{ marginLeft: '322px', width: 'inherit' }}>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div style={{ border: 'solid black', padding: '10px', borderWidth: 'thin', borderRadius: '5px', borderColor: '#009be5', marginBottom: '12px' }}>
            ...
            <Grid sx={Styles1.wrapper} container item xs spacing={2}>
              <Grid item xs={2}>
                <TextField
                  ...
                  helperText={errors.userDocument ? errors.userDocument.message : null}
                />
              </Grid>
              <Grid item xs={4}>
                <TextField
            ...
            <Grid sx={Styles1.wrapper} container item xs spacing={2}>
              <Grid item xs={3}>
                <TextField
                  ...
                  helperText={errors.userStreet ? errors.userStreet.message : null}
                />
              </Grid>
              <Grid item xs={4}>
                <TextField
                  ...
                  helperText={errors.userNumber ? errors.userNumber.message : null}
                />
              </Grid>
              <Grid item xs={3}>
                <TextField
              ...
              <Grid item xs={2}>
                <TextField
                  ...
                  helperText={errors.userPostalCode ? errors.userPostalCode.message : null}
                />
              </Grid>
            </Grid>
            <Grid sx={Styles1.wrapper} container item xs spacing={2}>
              <Grid item xs={3}>
                <TextField
                  ...
                  helperText={errors.userTelephone ? errors.userTelephone.message : null}
                />
              </Grid>
              <Grid item xs={3}>
                <TextField
                  ...
                  helperText={errors.userCellphone ? errors.userCellphone.message : null}
                />
              </Grid>
              <Grid item xs={3}>
                <TextField
            ...
            <Grid sx={Styles1.wrapper} container item xs spacing={2}>
              <Grid item xs={4}>
                <TextField
                  ...
                  helperText={errors.doctorTitle ? errors.doctorTitle.message : null}
                />
              </Grid>
              <Grid item xs={4}>
                <TextField
                  ...
                  helperText={errors.doctorSpecialization ? errors.doctorSpecialization.message : null
                  }
                />
              </Grid>
              <Grid item xs={2}>
              ...
              <Grid item xs={2}>
                <TextField
                  ...
                  helperText={errors.doctorTuitionNumber ? errors.doctorTuitionNumber.message : null
                  }
                />
              </Grid>
            </Grid>
            ...
            <Grid sx={Styles1.wrapper} container item xs spacing={2}>
              <Grid item xs={2}>
                <TextField
                  ...
                  helperText={errors.clinicLogo ? errors.clinicLogo.message : null}
                />
              </Grid>
              <Grid item xs={10}>
                <TextField
                  ...
                  helperText={errors.clinicName ? errors.clinicName.message : null}
                />
              </Grid>
            </Grid>
            <Grid sx={Styles1.wrapper} container item xs spacing={2}>
              ...
              <Grid item xs={3}>
                <TextField
                  ...
                  helperText={errors.clinicCity ? errors.clinicCity.message : null}
                />
              </Grid>
              <Grid item xs={2}>
                <TextField
                  ...
                  helperText={
                    errors.clinicPostalCode ? errors.clinicPostalCode.message : null
                  }
                />
              </Grid>
            </Grid>
            <Grid sx={Styles1.wrapper} container item xs spacing={2}>
              <Grid item xs={3}>
                <TextField
                  ...
                  helperText={errors.clinicTelephone ? errors.clinicTelephone.message : null}
                />
              </Grid>
              <Grid item xs={5}>
                <TextField
                  ...
                  helperText={errors.clinicEmail ? errors.clinicEmail.message : null}
                />
              </Grid>
              <Grid item xs={4}>
                <TextField
                  ...
                  helperText={errors.clinicHours ? errors.clinicHours.message : null}
                />
              </Grid>
            </Grid>
          </div>
